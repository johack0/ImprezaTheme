!function($){"use strict";const REGEXP_SPACE=/\p{Zs}/ug;function usItext(container){const self=this;self.$container=$(container);self.$parts=$('.w-itext-part',self.$container);if(!self.$parts.length){return}
