!function($,_undefined){"use strict";function usImageSlider(container){const self=this;const $container=$(container);const $frame=$('.w-slider-h',container);const $royalSlider=$('.royalSlider',container);const options={};if(!$.fn.royalSlider||$container.data('usImageSlider')){return}
...
$.fn.usImageSlider=function(){return this.each(function(){$(this).data('usImageSlider',new usImageSlider(this))})};$(()=>{$('.w-slider').usImageSlider()});$us.$document.on('usPostList.itemsLoaded usGrid.itemsLoaded',(_,$items)=>{$('.w-slider',$items).usImageSlider()})}(jQuery)