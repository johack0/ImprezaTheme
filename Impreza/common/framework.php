...
if ( ! defined( 'US_THEMENAME' ) OR ! defined( 'US_THEMEVERSION' ) ) {
	...
	if ( ! defined( 'US_HELP_PORTAL_URL' ) ) {
		$help_portal_url = defined( 'US_DEV_HELP' )
			? US_DEV_HELP
			: 'https://help.us-themes.com';
		define( 'US_HELP_PORTAL_URL', $help_portal_url );
	}
...
function us_theme_setup() {
	...
	if ( is_admin() OR ( defined( 'WP_CLI' ) AND WP_CLI ) ) {
		...
		require $us_template_directory . '/common/admin/functions/theme-updater.php';
...
// Remove built-in WordPress image sizes, which cannot be edited by UI.
// This improves control of image sizes, which can be easily managed on Theme Options > Image Sizes
