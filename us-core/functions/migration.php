...
class US_Migration {
	...
	public function output_migration_needed_js() {
		...
		$output .= 'jQuery(function($){
			...
			$("#allow_migration").prop("checked", false).on("click", function(){
				if ($(this).is(":checked")){
	...
	public function migration_completed_message() {
			...
			$output .= 'Now check your website. If you notice some issues, <a href="' . US_HELP_PORTAL_URL . '/' . strtolower( US_THEMENAME ) . '/tickets/" target="_blank">go to the support</a>.</h3>';
		}
