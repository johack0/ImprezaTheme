...
$showPasswordBtnAtts = array(
	 'type' => 'button',
	 'class' => 'show-password-btn',
	 'aria-label' => us_translate( 'Show password' ),
	 'aria-describedby' => 'password',
	 'data-show-password-translated' => us_translate( 'Show password' ),
	 'data-hide-password-translated' => us_translate( 'Hide password' ),
);
...
<div<?= us_implode_atts( $_atts ) ?>>
	...
	<div class="w-form-row-field">
		...
		<button<?= us_implode_atts( $showPasswordBtnAtts ) ?>></button>
