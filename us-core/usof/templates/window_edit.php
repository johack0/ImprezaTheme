...
<div class="us-bld-window for_editing">
	<div class="us-bld-window-h">
		<div class="us-bld-window-header">
			<div class="us-bld-window-title"<?= us_pass_data_to_js($titles) ?>></div>
			<div class="us-bld-window-closer" title="<?= us_translate( 'Close' ) ?>"></div>
		</div>
		<div class="us-bld-window-body usof-container"><?= $body ?><span class="usof-preloader"></span></div>
		<div class="us-bld-window-footer">
			<div class="usof-button button-primary type_save"><span><?= us_translate( 'Save Changes' ) ?></span></div>
		</div>
	</div>
</div>
