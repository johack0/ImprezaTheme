...
class us_migration_2_0 extends US_Migration_Translator {
	...
	public function migration_completed_message() {
		...
		$output .= '<p><strong>Migration to ' . US_THEMENAME . ' ' . US_THEMEVERSION . ' is completed</strong>. Now please regenerate thumbnails and check your website once again. If you notice some issues, <a href="'. US_HELP_PORTAL_URL .'/impreza/installation/update20/" target="_blank">follow the manual</a>.</p>';
		$output .= '</div>';
	...
	public function translate_meta( &$meta, $post_type ) {
		...
		// Cases that are hard to describe by rules

		// Translating us_header_type to us_header_pos & us_header_bg
