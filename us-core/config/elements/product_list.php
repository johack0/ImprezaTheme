...
$orderby_options = array(
	...
	'recent_sales' => __( 'Sales for last X days', 'us' ),
	'total_sales' => us_translate( 'Total sales', 'woocommerce' ),
...
$general_params = array(
	...
	'enable_items_offset' => array(
		'type' => 'switch',
		'switch_text' => __( 'Skip the specified quantity of products', 'us' ),
		'std' => 0,
		'classes' => 'for_above',
		'show_if' => array( 'source', '!=', array( 'upsells', 'crosssell' ) ),
		'usb_preview' => TRUE,
	),
	'items_offset' => array(
		'type' => 'slider',
...
$order_pagination_params = array(
	...
	'orderby_recent_sales_days' => array(
		'description' => __( 'Number of days, for example:', 'us' ) . ' <span class="usof-example">7</span>, <span class="usof-example">30</span>, <span class="usof-example">365</span>',
		'type' => 'text',
		'std' => '30',
		'classes' => 'for_above',
		'show_if' => array( 'orderby', '=', 'recent_sales' ),
		'group' => __( 'Order & Quantity', 'us' ),
		'usb_preview' => TRUE,
	),
...
$appearance_params = array(
	'items_layout' => array(
		...
		'type' => 'select',
		'options' => us_is_elm_editing_page()
			? us_get_grid_layouts_for_selection( array( 'blog', 'portfolio', 'shop' ) )
			: array(),
		'std' => 'shop_standard',
	...
	'img_aspect_ratio' => array(
		'title' => __( 'Product Image Aspect Ratio', 'us' ),
