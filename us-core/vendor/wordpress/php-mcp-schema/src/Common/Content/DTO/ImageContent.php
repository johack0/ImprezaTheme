 ...
 */
class ImageContent extends AbstractDataTransferObject implements SamplingMessageContentBlockInterface, ContentBlockInterface
{
    ...
    public const DISCRIMINATOR_VALUE = 'image';
    ...
    /**
     * @param string $data @since 2024-11-05
     * @param string $mimeType @since 2024-11-05
