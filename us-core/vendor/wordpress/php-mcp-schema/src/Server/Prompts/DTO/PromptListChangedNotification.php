 ...
 */
class PromptListChangedNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    public const DISCRIMINATOR_VALUE = 'notifications/prompts/list_changed';
