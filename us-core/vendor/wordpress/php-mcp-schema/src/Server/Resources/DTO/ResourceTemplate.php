 ...
 */
class ResourceTemplate extends BaseMetadata
{
     ...
     * @param string $uriTemplate @since 2024-11-05
    ...
    {
        self::assertRequired($data, ['name', 'uriTemplate']);
        ...
        return new self(
            ...
            self::asString($data['uriTemplate']),
