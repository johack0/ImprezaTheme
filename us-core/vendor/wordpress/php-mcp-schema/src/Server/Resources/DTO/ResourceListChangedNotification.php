 ...
 */
class ResourceListChangedNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    public const DISCRIMINATOR_VALUE = 'notifications/resources/list_changed';
