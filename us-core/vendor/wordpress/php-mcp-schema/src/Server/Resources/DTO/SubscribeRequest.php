 ...
 */
class SubscribeRequest extends JSONRPCRequest implements ClientRequestInterface
{
    ...
    public const DISCRIMINATOR_VALUE = 'resources/subscribe';

    /**
     * @var \WP\McpSchema\Server\Resources\DTO\SubscribeRequestParams
     */
    protected SubscribeRequestParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param string|number $id @since 2025-11-25
     * @param \WP\McpSchema\Server\Resources\DTO\SubscribeRequestParams $params @since 2024-11-05
     */
     ...
     *     params: array<string, mixed>|\WP\McpSchema\Server\Resources\DTO\SubscribeRequestParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \WP\McpSchema\Server\Resources\DTO\SubscribeRequestParams $params */
        $params = is_array($data['params'])
            ? SubscribeRequestParams::fromArray(self::asArray($data['params']))
            : $data['params'];
    ...
    /**
     * @return \WP\McpSchema\Server\Resources\DTO\SubscribeRequestParams
     */
    public function getTypedParams(): SubscribeRequestParams
    {
