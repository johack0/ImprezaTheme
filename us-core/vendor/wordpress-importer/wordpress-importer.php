...
/*
 * DEV Note: This is altered version of WordPress Importer. List of changes TO DO on each update:
 * All files: replace language functions with simple output
 * class-wp-import#64: replace set_time_limit() with us_set_time_limit()
 * class-wp-import#994: add meta for menu items, see issue #3917
 */
